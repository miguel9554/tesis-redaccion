...
de rectificación. En cuanto al sobretiro, tambien será filtrado debido al
...
Para esta función de rectifiación, se utilizó un diodo Schottky MA4E2502H
...
integrable. Su tensión de encendido es de \qty{0.65}{\milli\volt}, por lo que se
perdería esa amplitud del pulso de salida.
...
\ref{fig:stub_generator_sim_result}, se observa una caída en la amplitud de
\textcolor{red}{COMPLETAR VALOR}, dada por la tensión de encendido del Schottky
utilizado, y una anluación del sobretiro negativo.
...
\begin{equation}
    \begin{aligned}
        P_{M} = I_M^2 \cdot R_o &= \frac{T_{jM}-T_A}{\theta_{jA}} \\
        I_M &= \sqrt{\frac{T_{jM}-T_A}{\theta_{jA}}} \cdot \frac{1}{R_o} \\
    \end{aligned}
\end{equation}
