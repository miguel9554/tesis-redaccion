...
que brindan dos funciones diferenciadas, la llave y el capacitar. A la entrada
...
La llave, que conmuta entre $V_{dd}$ y tierra, según la señal de control
digital. De esta manera, la corriente que consume la carga es entregada por la
fuente y no por la señal de control digital. A la salida de la llave se generará
una señal cuadrada unipolar, pero a diferencia de la entrada, esta conmutará
entre $V_{dd}$ y tierra, mientras que a la entrada se conmuta entre $V_{dig}$ y
...
A la salida de la llave tenemos entonces una señal cuadarada unipolar, con
...
Para convertir este pulso unipolar en uno bipolar, se utiliza un capacitor en
serie $C$, que junto con la carga $Z_L$ forma un filtro pasaltos, eliminando la
componente continua de la cuadarada unipolar, resultando en una bipolar.
...
La cuadrada desarrollada en la impedancia de carga $Z_L$ será la cuadarada
...
Esta es la tensión $V_l$ en la ecuación de amplitud del pulso, entonces a más
$D$ mayor amplitud de pulso, vamos!
